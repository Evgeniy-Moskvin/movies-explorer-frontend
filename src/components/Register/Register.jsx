      ...
      <form name="register" onSubmit={handleSubmit(onSubmit)} className="user-form__form" noValidate>
        <div className="user-form__row">
          <label className="user-form__group">
            ...
            <input id="userName" name="name" type="text" placeholder="Имя"
                   className={`user-form__input ${errors?.userName ? 'user-form__input_error' : ''}`}
                   {...register('userName', {
        ...
        <div className="user-form__bottom">
          <button type="submit"
                  className={`form-button button-animate ${(!isValid || isSubmitting) ? 'form-button_disabled' : ''}`}
          ...
          <p className="user-form__text">Уже зарегистрированы? <Link to="/signin"
                                                                     className="user-form__link link-animate">Войти</Link>
          </p>
        </div>
      </form>
    </main>
